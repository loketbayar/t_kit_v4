...
//import com.topwise.emvtest.MainActivity;
...
//import com.topwise.emvtest.emv.EmvTags;
//import com.topwise.emvtest.emv.EmvTransProcessImpl;
//import com.topwise.emvtest.entity.TransData;
//import com.topwise.emvtest.enums.EnterMode;
//import com.topwise.emvtest.param.AidParam;
//import com.topwise.emvtest.param.CapkParam;
...
//
//                emv = MyApplication.usdkManage.getEmvHelper();
//                emv.init(einputType);
//
...
//                emv.setCapkList(MainActivity.getCapkList());
//                emv.setAidList(MainActivity.getAidList());
...
//                }
//                if (tlv !=null){
//                    AppLog.e("ActionEmvProcess","TAG57== " + MyApplication.convert.bcdToStr(tlv));
//                    transData.setTrack2(MyApplication.convert.bcdToStr(tlv));
//                }
//                if (f55 !=null){
...
//                if (MyApplication.POS_MODE == MyApplication.POS_MP35P && einputType == EinputType.RF){
//                    try {
//                        MyApplication.usdkManage.getRf().close();
...
//        byte[] countryCode = MyApplication.convert.strToBcd(String.format("%04d",Integer.parseInt("356")), IConvert.EPaddingPosition.PADDING_RIGHT);
